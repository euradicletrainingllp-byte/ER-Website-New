        ...
        <div className="lg:col-span-3 flex flex-col justify-between items-center lg:items-start space-y-8 sm:space-y-10 lg:space-y-12">
          <div className="space-y-6 sm:space-y-8">
            ...
            <div className="flex flex-wrap justify-center lg:justify-start gap-4 sm:gap-5 text-lg sm:text-xl text-primary-navy/80">
              <a
                href="https://www.linkedin.com/company/euradicle-training-india/posts/?feedView=all"
                target="_blank"
                rel="noopener noreferrer"
                className="p-2 rounded-full border border-brand-400/20 hover:bg-white hover:text-[var(--color-primary-mauve)] transition-all duration-300"
              >
                <FaLinkedinIn />
              </a>
              <a
                href="https://www.instagram.com/euradicle/?hl=en"
                target="_blank"
                rel="noopener noreferrer"
                className="p-2 rounded-full border border-brand-400/20 hover:bg-white hover:text-[var(--color-primary-mauve)] transition-all duration-300"
              >
              ...
              <a
                href="https://www.facebook.com/EuRadicleTrainingIndia/"
                target="_blank"
                rel="noopener noreferrer"
                className="p-2 rounded-full border border-brand-400/20 hover:bg-white hover:text-[var(--color-primary-mauve)] transition-all duration-300"
              >
              ...
              <a
                href="https://www.youtube.com/channel/UC5pBaWce56rhEgrfEtj--3g"
                target="_blank"
                rel="noopener noreferrer"
                className="p-2 rounded-full border border-brand-400/20 hover:bg-white hover:text-[var(--color-primary-mauve)] transition-all duration-300"
              >
            ...
            <div className="flex flex-col items-center space-y-4 2xl:space-y-5 text-body-sm 2xl:text-base text-primary-navy/80 mt-4">
              <Link
                to="/privacy-and-policy"
                className="hover:text-[var(--color-primary-mauve)] transition-colors"
              >
                Privacy Policy
              </Link>
              <Link
        ...
        <div className="lg:col-span-3">
          ...
          <nav className="flex flex-col space-y-4 2xl:space-y-5 text-body-sm 2xl:text-base text-primary-navy/80">
            <Link
              ...
              className="hover:text-[var(--color-primary-mauve)] transition-colors w-fit"
            >
        ...
        <div className="lg:col-span-3">
          ...
          <div className="flex flex-col space-y-6 2xl:space-y-8 text-body-sm 2xl:text-base text-primary-navy/80">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3 hover:text-[var(--color-primary-mauve)] transition-colors">
                <img
